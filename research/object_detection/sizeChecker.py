...
# Directories
train_directory = './Image/train' # It should contain the xml files with bounding boxes
test_directory = './Image/test' # It should contain the xml files with bounding boxes
